# Difference in Difference Estimation for Actor Salience
# Considering visibilty of political parties
...
treatment_year <- 2016
df$first_treat <- ifelse(df$treat == 1, treatment_year, 0)
...
# Save the results
saveRDS(results, "results/1b_paragraphs_parties.RDS")
