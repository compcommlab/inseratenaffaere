# Difference in Difference Estimation for Actor Visibility
# Considering visibilty of individual politicians
...
# Save the results
saveRDS(results, "results/1a_paragraphs_politicians.RDS")
